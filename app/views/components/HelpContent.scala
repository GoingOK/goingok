    ...
    div(`class`:="row",
      ...
      div(`class`:="col-sm-2",
        div(`class`:="list-group",
          a(`class`:="list-group-item list-group-item-action active", href:="#")("Overview"),
          a(`class`:="list-group-item list-group-item-action", href:="#")("Privacy"),
          a(`class`:="list-group-item list-group-item-action", href:="#")("Research"),
          a(`class`:="list-group-item list-group-item-action", href:="#")("How to Use"),
          a(`class`:="list-group-item list-group-item-action", href:="#")("Other Info")
        )
      ),
      div(`class`:="col-sm-8",
        div(id:="overview",
        ...
        div(id:="using_info",
          ...
          p("If you're not sure how to use GoingOK, follow these steps to get started...")
        ),
        div(id:="other_info",
          h4("Tech Details"),
          p("")
